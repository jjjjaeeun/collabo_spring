...
public class Product {
    // 엔터티 코딩 작성시 database의 제약 조건도 같이 고려해야함.
    @Id
    ...
    @Column(nullable = false)
    @Min(value = 10, message = "가격은 10개 이상이어야 합니다.")
    @Max(value = 3000, message = "가격은 3000개 이하이어야 합니다.")
    private int stock;
    ...
    @Size(max = 1000, message = "상품에 대한 설명은 최대 1,000자 이하로 입력해주세요.")
